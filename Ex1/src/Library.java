...
public class Library {
     ...
     * @return a non-negative id number for the patron if there was a spot and the patron was successfully registered or
     * if the patron was already registered. a negative number otherwise.
     */
