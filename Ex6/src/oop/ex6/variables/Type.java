...
public interface Type {
    ...
    default void nameVerifier(String name, HashMap<String, String[]> curHash, boolean isDec) throws RuntimeException{
    ...
    void valueVerifier(String value, HashMap<String, String[]> curHash) throws RuntimeException;
