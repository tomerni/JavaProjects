...
public class ClosedHashSet extends SimpleHashSet {
    ...
    private void findSpaceAndAdd(Object newValue, Object[] hashTable) {
        for (int i = 0; i < hashTable.length; i++) {
            ...
            if (hashTable[index] == null | hashTable[index] == deletedString) {
     ...
     */
    private void reHash() {
        String[] newHashTable = new String[curCapacity];
        for (String s : hashTable) {
            if (s != null & s != deletedString) {
    ...
    public boolean contains(String searchVal) {
        for (int i = 0; i < curCapacity; i++) {
            ...
            if (hashTable[index] == deletedString) {
                continue;
            }
